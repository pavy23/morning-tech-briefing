...
const READER_PROFILE = {
  role: "Engineer at Samsung Heavy Industries (shipbuilding and offshore) since 2009, with experience in design, sales, basic design, and corporate research",
  education: "BS mechanical engineering, MBA, PhD candidate in technology management",
  briefing_purpose: "Daily global tech news in AI, XR, space industry, and robotics",
  strong_interests: [
    "shipbuilding, offshore, maritime, and heavy-industry applications",
    ...
    questions: {
      relevance: score(
        ...
        [
          ...
          "Level 3: Directly relevant. Concerns shipbuilding, offshore, maritime, heavy industry, industrial or humanoid robots deployed in factories, or a strategic shift large enough that the reader's company would need to respond.",
        ]
      ),
      category: choice(
